 ...
 *
 * @note        Copy this file into your own project as "fsm_config.h" and edit
 *              it there. Keeping your copy outside the library means updating
 *              the library never overwrites your settings.
 */
